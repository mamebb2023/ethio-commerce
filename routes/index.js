...
const routerController = (app) => {
  app.use(
    "/uploads",
    express.static(path.resolve(path.dirname(""), "uploads"))
  );
  app.use(express.static(path.resolve(path.dirname(""), "views")));
  app.use("/", router);
  ...
  router.get("/register", (req, res) =>
    res.sendFile(path.resolve(path.dirname(""), "views/register.html"))
  );
  router.get("/login", (req, res) =>
    res.sendFile(path.resolve(path.dirname(""), "views/login.html"))
  );
  ...
  router.get(
    ...
    userUtils.isAdmin,
    (req, res) => {
      res.sendFile(path.resolve(path.dirname(""), "views/admin.html"));
    }
  );
  router.post(
    "/post-item",
  ...
  router.get(
    ...
    AuthController.verifyUser,
    userUtils.isAdmin,
    (req, res) => AppController.getStatus(req, res)
  );

  // User sites
  router.get("/user/me", AuthController.verifyUser, (req, res) =>
    res.sendFile(path.resolve(path.dirname(""), "views/user.html"))
  );
  router.get("/user/cart", AuthController.verifyUser, (req, res) =>
    res.sendFile(path.resolve(path.dirname(""), "views/cart.html"))
  );
  router.post("/add-cart", AuthController.verifyUser, (req, res) =>
    ItemController.addToCart(req, res)
  );
  router.post("/remove-cart", AuthController.verifyUser, (req, res) =>
    ItemController.removeFromCart(req, res)
  );
  router.get("/cart-items", AuthController.verifyUser, (req, res) =>
    ItemController.totalCartItems(req, res)
  );
  router.get("/cart", AuthController.verifyUser, (req, res) =>
    ItemController.cartItems(req, res)
  );
  ...
  router.post("/logout", AuthController.verifyUser, (req, res) =>
